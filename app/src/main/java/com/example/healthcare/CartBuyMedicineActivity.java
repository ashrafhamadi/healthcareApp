...
public class CartBuyMedicineActivity extends AppCompatActivity {
    ...
    private Button dateBtn,timeBtn,btnBack, btnCheckout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack = (Button) findViewById(R.id.buttonCBMBack);
        btnCheckout = (Button) findViewById(R.id.buttonCBMBook);
        dateBtn = (Button) findViewById(R.id.buttonCBMDate);
        timeBtn = (Button) findViewById(R.id.buttonCBMTime);
        tvTotal = (TextView) findViewById(R.id.textViewTotalCostCBM);
        lst = (ListView) findViewById(R.id.ListViewCBM);
