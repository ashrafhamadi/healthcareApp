...
public class CartLabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack = (Button) findViewById(R.id.buttonCLBack);
        btnCheckout = (Button) findViewById(R.id.buttonCLBook);
        dateBtn = (Button) findViewById(R.id.buttonCLDate);
        timeBtn = (Button) findViewById(R.id.buttonCLTime);
        tvTotal = (TextView) findViewById(R.id.textViewTotalCost);
        lst = (ListView) findViewById(R.id.ListViewCL);
